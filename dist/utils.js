...
const translations = {
    es: {
        ...
        'dash-plan-manage': 'Gestionar Suscripción',
        'dash-kpi-incidents': 'Incidentes (24h)',
        'dash-kpi-verified': 'Verificados',
        'dash-kpi-zones': 'Zonas Críticas',
        'dash-kpi-witnesses': 'Testigos Activos',
        'dash-chart-trend': 'Tendencia de Incidentes',
        'dash-chart-cat': 'Distribución por Categoría',
        'dash-feed-title': 'Feed de Verificación Prioritaria',
